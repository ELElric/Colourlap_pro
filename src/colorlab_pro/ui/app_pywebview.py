...
替代原 PySide6 的 app.py，使用 pywebview + 内置 HTTP server 提供前端页面。
"""
...
# ------------------------------------------------------------------ #
# Database initialization (copied from app.py)
# ------------------------------------------------------------------ #
...
def main(argv: list[str] | None = None) -> int:
    ...
    # QObject.__init__, Signal definitions and QSettings work.  pywebview
